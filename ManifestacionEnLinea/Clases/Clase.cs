...
namespace ManifestacionEnLinea.Clases
{
    public class Clase
    {
        ...
        public void ActualizarControlFoliosMCAV(string clavecatastral, int ControlFolios)
        {
            string conexion = System.Configuration.ConfigurationManager.ConnectionStrings["WFTRAMITESConnectionString"].ConnectionString;
            System.Data.SqlClient.SqlConnection sqlConnection1 = new System.Data.SqlClient.SqlConnection(conexion);
            System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
            ...
            cmd.CommandText = "UPDATE WFTRAMITES.dbo.SIS_TRACAT_MC_AV SET CONTROLFOLIO ="+ ControlFolios + "  WHERE CVE_CAT_ORI = '" + clavecatastral + "' and STATUSREGISTROTABLA='ACTIVO' ";
            cmd.Connection = sqlConnection1;
            sqlConnection1.Open();
            cmd.ExecuteNonQuery();
            sqlConnection1.Close();
        ...
        public void ActualizarControlFoliosMC(string clavecatastral, int ControlFolios)
        {
            string conexion = System.Configuration.ConfigurationManager.ConnectionStrings["WFTRAMITESConnectionString"].ConnectionString;
            System.Data.SqlClient.SqlConnection sqlConnection1 = new System.Data.SqlClient.SqlConnection(conexion);
            System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
            ...
            cmd.CommandText = "UPDATE WFTRAMITES.dbo.SIS_TRACAT_MC SET CONTROLFOLIO =" + ControlFolios + "  WHERE CVE_CAT_ORI = '" + clavecatastral + "' and STATUSREGISTROTABLA='ACTIVO' ";
            cmd.Connection = sqlConnection1;
            sqlConnection1.Open();
            cmd.ExecuteNonQuery();
            sqlConnection1.Close();
        ...
        public void ActualizarControlFoliosAV(string clavecatastral, int ControlFolios)
        {
            string conexion = System.Configuration.ConfigurationManager.ConnectionStrings["WFTRAMITESConnectionString"].ConnectionString;
            System.Data.SqlClient.SqlConnection sqlConnection1 = new System.Data.SqlClient.SqlConnection(conexion);
            System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand();
            ...
            cmd.CommandText = "UPDATE WFTRAMITES.dbo.SIS_TRACAT_AC SET CONTROLFOLIO =" + ControlFolios + "  WHERE CVE_CAT_ORI = '" + clavecatastral + "' and STATUSREGISTROTABLA='ACTIVO' ";
            cmd.Connection = sqlConnection1;
            sqlConnection1.Open();
            cmd.ExecuteNonQuery();
            sqlConnection1.Close();
