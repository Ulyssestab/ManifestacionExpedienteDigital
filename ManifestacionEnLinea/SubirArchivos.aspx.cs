...
namespace ManifestacionEnLinea
{
    public partial class SubirArchivos : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                if (Session["ClaveCatastral"] != null || !string.IsNullOrEmpty(Session["ClaveCatastral"].ToString()))
                {
                    /*descencriptar clave catastral*/

                    CuentaGlobal = Session["ClaveCatastral"].ToString();

                    /*Obtener el tramite seleccionado*/
                    Tramite = Session["TramiteSeleccionado"].ToString();
        ...
        protected void InsertarInfoMani()
        {
            ...
            cnnInfo.Open();
            SqlCommand cmdInfo = new SqlCommand("select top 1 CVE_CAT_EST,CVE_PREDIAL,FOLIO_REAL from GDB010" + Municipio + ".SDE.SIS_PC_CLAVE_CATASTRAL where STATUSREGISTROTABLA='ACTIVO' AND CVE_CAT_ORI='" + ClaveCatastral + "' order by OBJECTID desc", cnnInfo);
            ...
            try
            {
                ...
                cnnUbi.Open();
                SqlCommand cmdUbi = new SqlCommand("select top 1 NOMBRE_COMPLETO_VIALIDAD,NUMERO_EXTERIOR,NUMERO_INTERIOR,NOMBRE_COMPLETO_ASENTAMIENTO,CP,NOM_LOCALIDAD,NOM_MUNICIPIO,NOM_ENTIDAD from GDB010" + Municipio + ".sde.SIS_PC_UBICACION WHERE CVE_CAT_ORI='" + ClaveCatastral + "' and STATUSREGISTROTABLA='ACTIVO'", cnnUbi);
            ...
            try
            {
                ...
                string QueryInsertMC = "insert into WFTRAMITES.dbo.SIS_TRACAT_MC(STATUSREGISTROTABLA, ALTAREGISTROTABLA, BAJAREGISTROTABLA, USUARIOALTA, USUARIOBAJA, FOLIO_TRAMITE, TIPO_TRAMITE, CVE_CAT_EST, CVE_CAT_ORI, CVE_PREDIAL, OBSERVACIONES, TRAMITADOR, EN_USO, IMAGEN, SOLICITANTE, PROPIETARIO, UBICACION, NOTIFICACION, NOTIFICACION_RECHAZO, AVALUO, FOLIO_PAGO_AVALUO, IGUAL_CARTOGRAFIA,CORREOELECTRONICO,CONTROLFOLIO) VALUES \n" +
                     "('ACTIVO','" + fechaAlta.ToString(FormatoFecha) + "',NULL,'UsuarioExterno',NULL,'" + FORMATOMANI + "','MANIFESTACIÓN DE CONSTRUCCIÓN','" + ESTANDAR + "','" + ClaveCatastral + "','" + PREDIAL + "','','',0,NULL,'" + NombreSol + "',NULL,'" + NOMBRE_COMPLETO_UBI + "',NULL,0,0,NULL,0,'"+correoelec+"',NULL)";
        ...
        {
            string ClaveCatastral = Session["ClaveCatastral"].ToString();
            string FormatoFecha = "yyyy-MM-dd HH:mm:ss:fff";
            string Municipio = ClaveCatastral.Substring(0, 2);
            ...
            cnnInfoAvaluo.Open();
            SqlCommand cmdInfoAvaluo = new SqlCommand("select top 1 CVE_CAT_EST,CVE_PREDIAL,FOLIO_REAL from GDB010" + Municipio + ".SDE.SIS_PC_CLAVE_CATASTRAL where STATUSREGISTROTABLA='ACTIVO' AND CVE_CAT_ORI='" + ClaveCatastral + "' order by OBJECTID desc", cnnInfoAvaluo);
            ...
            try
            {
                ...
                cnnUbiAvaluo.Open();
                SqlCommand cmdUbiAvaluo = new SqlCommand("select top 1 NOMBRE_COMPLETO_VIALIDAD,NUMERO_EXTERIOR,NUMERO_INTERIOR,NOMBRE_COMPLETO_ASENTAMIENTO,CP,NOM_LOCALIDAD,NOM_MUNICIPIO,NOM_ENTIDAD from GDB010" + Municipio + ".sde.SIS_PC_UBICACION WHERE CVE_CAT_ORI='" + ClaveCatastral + "' and STATUSREGISTROTABLA='ACTIVO'", cnnUbiAvaluo);
            ...
            try
            {
                ...
                string QueryInsertAC = "insert into WFTRAMITES.dbo.SIS_TRACAT_AC(STATUSREGISTROTABLA, ALTAREGISTROTABLA, BAJAREGISTROTABLA, USUARIOALTA, USUARIOBAJA, TIPO_TRAMITE,FOLIO_TRAMITE, CVE_CAT_EST, CVE_CAT_ORI, OBSERVACIONES, TRAMITADOR, SOLICITANTE, UBICACION, FOLIO_MC, FOLIO_PAGO_AVALUO, NO_NOTARIA, NO_ESCRITURA, NATURALEZA_DEL_ACTO,BANDERA_EXTERNO,BANDERA_ACEPTADO,CORREOELECTRONICO,CONTROLFOLIO) VALUES \n" +
                     "('ACTIVO','" + fechaAlta.ToString(FormatoFecha) + "',NULL,'UsuarioExterno',NULL,'SOLICITUD DE AVALÚO CATASTRAL','" + FORMATOAVALUO + "','" + ESTANDARAVALUO + "','" + ClaveCatastral + "',NULL,'','" + NombreSolAvaluo + "','" + NOMBRE_COMPLETO_UBIAVALUO + "',NULL,'"+CfdioReferencia+"',NULL,NULL,NULL,NULL,NULL,'" + correoelec +"',NULL)";
        ...
        {
            string Txt_ClaveCatastral = cuentasubFiles.Text;
            string Municipio = Txt_ClaveCatastral.Substring(0, 2);//Sacar el Municipio de el Predio
            ...
            SqlCommand cmdInfoManiAvaluo = new SqlCommand("select top 1 CVE_CAT_EST,CVE_PREDIAL,FOLIO_REAL from GDB010" + Municipio + ".SDE.SIS_PC_CLAVE_CATASTRAL where STATUSREGISTROTABLA='ACTIVO' AND CVE_CAT_ORI='" + Txt_ClaveCatastral + "' order by OBJECTID desc", cnnInfoManiAvaluo);
            ...
            try
            {
                ...
                SqlCommand cmdUbiManiAvaluo = new SqlCommand("select top 1 NOMBRE_COMPLETO_VIALIDAD,NUMERO_EXTERIOR,NUMERO_INTERIOR,NOMBRE_COMPLETO_ASENTAMIENTO,CP,NOM_LOCALIDAD,NOM_MUNICIPIO,NOM_ENTIDAD from GDB010" + Municipio + ".sde.SIS_PC_UBICACION WHERE CVE_CAT_ORI='" + Txt_ClaveCatastral + "' and STATUSREGISTROTABLA='ACTIVO'", cnnUbiManiAvaluo);
            ...
            try
            {
                ...
                string QueryInsertMCManiAvaluo = "insert into WFTRAMITES.dbo.SIS_TRACAT_MC_AV(STATUSREGISTROTABLA, ALTAREGISTROTABLA, BAJAREGISTROTABLA, USUARIOALTA, USUARIOBAJA, FOLIO_TRAMITE, TIPO_TRAMITE, CVE_CAT_EST, CVE_CAT_ORI, CVE_PREDIAL, OBSERVACIONES, TRAMITADOR, EN_USO, IMAGEN, SOLICITANTE, PROPIETARIO, UBICACION, NOTIFICACION, NOTIFICACION_RECHAZO, AVALUO, FOLIO_PAGO_AVALUO, IGUAL_CARTOGRAFIA,CORREOELECTRONICO,CONTROLFOLIO) VALUES \n" +
                     "('ACTIVO','" + fechaAlta.ToString(FormatoFecha) + "',NULL,'UsuarioExterno',NULL,'" + FORMATOMANI + "','MANIFESTACIÓN DE CONSTRUCCIÓN','" + ESTANDAR + "','" + Txt_ClaveCatastral + "','" + PREDIAL + "','','',0,NULL,'" + NombreSol + "',NULL,'" + NOMBRE_COMPLETO_UBI + "',NULL,0,1,NULL,0,'"+ correoelec +"',NULL)";
            ...
            try
            {
                ...
                string QueryInsertTramiteManiAvaluo = "insert into WFTRAMITES.dbo.Tramite(ClaveCatastralOriginal, ClaveCatastralEstandar, FechaInicial, FechaFinal, FK_CatEstatus, Pagado, Condonado, FK_Cat_Notaria, Prioridad, Observaciones, FK_Cat_TipodeProcesoTramite, FK_NombreUsuario, Region, Manzana, Lote, Departamento, FK_Cat_TipodePredio, NumeroCuenta, Delegacion, NumeroTramite, FK_Cat_Solicitante, NombrePersonalSolicitante, ObservacionAclaracion, Procede, Entidad, Tipo, Año, Consecutivo, Derivada, TipoBusqueda, Bloqueado, Reserva, Rechazado, NumeroClave, NumeroCuentas, Excentopago, FK_Cat_TipoClaveCatastralGenerada, FK_Cat_TipoInspeccion, PagarReingreso, NumeroTramiteSIC, NumeroTramiteValuacion, ProntoPago, Sector, Localidad, Predio, Edificio, Unidad, Zona, FK_Cat_Municipio, RequiereCartografia, ObjectId_Cartografico, Condominio, OtroEstado, Folio, Corett, FK_Cat_Dependencia, Habilitado, SuperficieConstruccion, SuperficieTerreno, usuarioSolicitante, Observaciones_Rechazo_Direccion, FK_CatCoordinacion, USUARIOCANCELA) VALUES \n" +
                     "('" + Txt_ClaveCatastral + "','" + ESTANDAR + "','" + fechaAlta.ToString(FormatoFecha) + "',NULL,2,0,0,0,'Alta',NULL,2,'UsuarioExterno',NULL,NULL,NULL,NULL,1,NULL,0,'" + FORMATOMANI + "',1,'" + NombreSol + "',NULL,NULL,NULL,'MANIFESTACIÓN DE CONSTRUCCIÓN',NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,0,NULL,NULL,NULL,0,NULL,NULL,1,NULL,NULL,'UsuarioExterno',NULL,1,NULL)";
        ...
        protected void GuardarArchivosManifestacion(string ClaveCatastral)
        {
            
            string strFolder;
            strFolder = @"\\"+ IPServidor + "\\irc\\Archivos\\ManifestacionCatastralEnLinea";

            string path = strFolder + "\\" + ClaveCatastral;
        ...
        private void GuardarArchivosAvaluo(string ClaveCatastral)
        {
        ...
        protected void GuardarArchivosManiAvaluo(string ClaveCatastral)
        {
            string strFolder;
            strFolder = @"\\"+IPServidor+"\\irc\\Archivos\\ManifestacionCatastralEnLinea";
        ...
        protected void ObtenerFolioControlManifestacion(string EmailCat)
        {
            ...
            var resultado = cf.AgregarFolio(f, "Av@ge14#");
            ...
            {
                ObjetosPago.ActualizarControlFoliosMC(ClaveCatastral, FolioControl);
                PdfWriter writer = new PdfWriter("\\\\"+IPServidor+"\\irc\\Archivos\\ManifestacionCatastralEnLinea\\" + ClaveCatastral + "\\BoletaparaDescargar.pdf"); 
                ...
                Cell cell41 = new Cell(1, 1)
                    .SetTextAlignment(TextAlignment.LEFT)
                    .Add(new Paragraph("OBSERVACIÓNES:" + "Cuenta Catastral: " + ClaveCatastral + " " + FORMATOMANI + " " + "Igual a cartografía:" + resp));
                ...
                wp.EnvioCorreoTramiteAdjuntoManifestacion(NombreSol, EmailCat, ClaveCatastral, "Manifestación Catastral");
        ...
        private void ObtenerFolioControlAvaluo(string EmailCat)
        {
            ...
            var resultadoAvaluo = cfAvaluo.AgregarFolioAvaluoCatastral(fAvaluo, "Av@ge14#");
            ...
            else
            {
                ...
                PdfWriter writerAvaluo = new PdfWriter("\\\\"+IPServidor+"\\irc\\Archivos\\AvaluoCatastralEnLinea\\" + ClaveCatastral + "\\BoletaparaDescargar.pdf"); //Produccion
                ...
                Cell cell41Avaluo = new Cell(1, 1)
                    .SetTextAlignment(TextAlignment.LEFT)
                    .Add(new Paragraph("OBSERVACIÓNES:" + "Cuenta Catastral: " + ClaveCatastral + " " + FORMATOAVALUO + " "));
                ...
                wp.EnvioCorreoTramiteAdjuntoAvaluo(NombreSolAvaluo, EmailCat, ClaveCatastral, "Avalúo Catastral");
        ...
        protected void ObtenerFolioControlManiAvaluo(string EmailCat)
        {
            ...
            f.nombreSolicitante = NombreSol;
            f.observacion = "Manifestacion En linea, " + FORMATOMANI + " " + ClaveCatastral;
            ...
            {
                ObjetosPago.ActualizarControlFoliosMCAV(ClaveCatastral, FolioControl);
                PdfWriter writerManiAvaluo = new PdfWriter("\\\\"+IPServidor+"\\irc\\Archivos\\ManifestacionCatastralEnLinea\\" + ClaveCatastral + "\\BoletaparaDescargar.pdf"); //Produccion
                ...
                wp.EnvioCorreoTramiteAdjuntoManifestacion(NombreSol, EmailCat, ClaveCatastral, "Manifestación Catastral con Avalúo");
            }
        }
        protected void UploadButton_Click(object sender, EventArgs e)
        {
            string Txt_FolioPagoAvaluo = TxtFolioPago.Text;
            string Txt_NombreSolicitante = inputSolicitanteUpload.Text;
            string Txt_CorreoElectronico = CorreoElectronico.Text;
            string Txt_Tramite = TxtTramite.Text;
            string Txt_ClaveCatastral = cuentasubFiles.Text;
            Boolean Archivo = FileUploadControl.HasFile; /*InputField Archivos*/
            if (Txt_Tramite == "MANIFESTACIÓN CON AVALÚO")
            {
                /*Valida si escribieron el folio de pago*/
                if (!string.IsNullOrEmpty(Txt_FolioPagoAvaluo))
                {
                    /*Valida si escribieron el nombre del solicitante*/
                    if (!string.IsNullOrEmpty(Txt_NombreSolicitante))
                    {
                        /*Valida si escribieron correo electronico*/
                        if (!string.IsNullOrEmpty(Txt_CorreoElectronico))
                        {
                            Session["CorreoElectronico"] = Txt_CorreoElectronico;
                            /*Valida si ingresaron documento*/
                            if (Archivo == true)
                            {
                                ...
                                if (infoMCAV == null)
                                {
                                    ...
                                    InsertarInfoManiyAvaluo();
                                    ObtenerFolioControlManiAvaluo(Txt_CorreoElectronico);
                                    Response.Redirect("DescargaBoleta.aspx");
                                }
                                else
                                {
                            ...
                            {
                                ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "warningsalert('Ingresa la documentación');", true);
                            }
                        }
                        else
                        {
                            ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "warningsalert('Ingresar correo electronico');", true);
                        }
                    }
                    else
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "warningsalert('Ingresar nombre del solicitante');", true);
                    }
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "warningsalert('Ingresar folio del pago');", true);
                }
            }
            if (Txt_Tramite == "AVALÚO CATASTRAL")
            {
                /*Valida si escribieron el folio de pago*/
                if (!string.IsNullOrEmpty(Txt_FolioPagoAvaluo))
                {
                    ...
                    if (!string.IsNullOrEmpty(Txt_NombreSolicitante))
                    {
                        ...
                        if (!string.IsNullOrEmpty(Txt_CorreoElectronico))
                        {
                            ...
                            if (Archivo == true)
                            {
                                /*Valida si ya se registro en SIS_TRACAT_AC*/
                                SIS_TRACAT_AC infoAV = ObjetosPago.ValidarSolicitudAV(Txt_ClaveCatastral);
                                if (infoAV == null)
                                {
                                    GuardarArchivosAvaluo(Txt_ClaveCatastral);
                                    InsertarInfoAvaluo();
                                    ObtenerFolioControlAvaluo(Txt_CorreoElectronico);
                                    Response.Redirect("DescargaBoleta.aspx");
                                }
                                else
                                {
            ...
            if (Txt_Tramite == "MANIFESTACIÓN DE CONSTRUCCIÓN")
            {
                /*Valida si escribieron el nombre del solicitante*/
                if (!string.IsNullOrEmpty(Txt_NombreSolicitante))
                {
                    ...
                    if (!string.IsNullOrEmpty(Txt_CorreoElectronico))
                    {
                        ...
                        if (Archivo == true)
                        {
                            /*Valida si ya se registro en SIS_TRACAT_MC*/
                            SIS_TRACAT_MC infoMC = ObjetosPago.ValidarSolicitudMC(Txt_ClaveCatastral);
                            if (infoMC == null)
                            {
                                GuardarArchivosManifestacion(Txt_ClaveCatastral);
                                InsertarInfoMani();
                                ObtenerFolioControlManifestacion(Txt_CorreoElectronico);
                                Response.Redirect("DescargaBoleta.aspx");
                            }
                            else
                            {
